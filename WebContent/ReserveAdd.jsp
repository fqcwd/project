		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default"  style="margin-top:30px;width: 400px;margin-left: -50px;">
				...
				<div class="panel-body">
					<form role="form" method="post" action="orderAdd.action">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="姓名" id="name" name="Name" type="text" autofocus="" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="房间号" id="roomId" name="RoomId" type="text" value="" required="true" onKeyDown="return isNumber();">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="身份证" id="idCard" name="IDCard" type="text" value="" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="手机号" id="tel" name="Phone" type="text" value="" required="true" onKeyDown="return isNumber();">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="form-control" placeholder="总金额" id="price" name="Price" type="text" value="" required="true" onKeyDown="return isNumber();">
							</div>
							<div class="form-group">
