...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row" style="margin:50px 0 0 30px;">
			<div class="col-lg-12">				
					<form role="form" class="form-inline" method="post" action="liveCancel.action" >
						<fieldset>
							<div class="form-group">
								退房的房间号：
								<input class="form-control " placeholder="房间号" name="roomId" id="login" type="text" required="true" onKeyDown="return isNumber();">
							</div>
							<div class="form-group">
